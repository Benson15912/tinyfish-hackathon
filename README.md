...
* **Backend:** Python
* **Automation:** TinyFish (browser automation agent)
* **Storage:** JSON / Markdown (`profile.md`)
* **Processing:** Rule-based + LLM-powered reasoning
...
```bash
git clone https://github.com/yourusername/adulting.sg.git
cd adulting.sg
```
...
* CPF tracking and retirement projections
* Budget forecasting and simulation
* Telegram/WhatsApp integration for daily insights
* Real-time alerts for new BTO launches or card promotions

---

## 💡 Vision

adulting.sg aims to become a **personal decision-making agent** — not just tracking your life, but actively guiding you through it.

Instead of spending hours researching financial products or housing options, users can rely on a system that continuously works in the background to surface what matters most.
